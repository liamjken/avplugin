...
function vsa_listings_buttons_function() {
	...
	ob_start();
	?> 
                <a class="srp-vsa-b" href="/virtual-sales-assistant/?<?php echo esc_attr($vin_num); ?>" target=_deal><img src="<?php echo plugin_dir_url( __DIR__ ) . '/img/CTA_With_No_Negotiate_TextOnly.gif'; ?>" style="margin-top: 10px; width:100%;border-radius: 20px;"></a> <?php
	return ob_get_clean();
}
